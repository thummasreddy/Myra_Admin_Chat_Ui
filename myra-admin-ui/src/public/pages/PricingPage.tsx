          ...
          {plans.map((plan, index) => (
            <Card key={plan.id} className={`public-card public-plan-card flex flex-col ${index === 3 ? "border-primary/40" : ""}`}>
              ...
              <CardContent className="flex flex-1 flex-col">
                ...
                <Button asChild className="mt-6 bg-accent text-accent-foreground shadow-[0_12px_28px_rgba(200,154,75,0.24)] hover:bg-accent/90 hover:shadow-[0_16px_36px_rgba(200,154,75,0.28)]">
