            ...
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  ...
                  isActive
                    ? "border-blue-300/35 bg-white/10 text-white shadow-lg shadow-blue-500/10"
                    : "border-transparent text-slate-400 hover:border-white/10 hover:bg-white/[0.06] hover:text-white"
                )
              }
            >
              <span className="flex h-8 w-8 items-center justify-center rounded-md bg-white/[0.06] text-blue-300 transition-colors group-hover:bg-white/10">
